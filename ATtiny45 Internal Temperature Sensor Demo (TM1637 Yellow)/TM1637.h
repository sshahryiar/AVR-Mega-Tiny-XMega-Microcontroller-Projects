...
#define TM1637_CLK_PIN_DIR          DDB3_bit
#define TM1637_DAT_PIN_DIR          DDB4_bit

#define TM1637_CLK_PIN              PORTB3_bit
#define TM1637_DAT_PIN              PORTB4_bit

#define TM1637_DAT_PIN_DIR_IN       do{TM1637_DAT_PIN_DIR = LOW;}while(0)

#define TM1637_CLK_PIN_DIR_OUT      do{TM1637_CLK_PIN_DIR = HIGH;}while(0)
#define TM1637_DAT_PIN_DIR_OUT      do{TM1637_DAT_PIN_DIR = HIGH;}while(0)
                                                                    
#define TM1637_CLK_HIGH             do{TM1637_CLK_PIN = HIGH;}while(0)
#define TM1637_CLK_LOW              do{TM1637_CLK_PIN = LOW;}while(0)

#define TM1637_DAT_HIGH             do{TM1637_DAT_PIN = HIGH;}while(0)
#define TM1637_DAT_LOW              do{TM1637_DAT_PIN = LOW;}while(0)

#define TM1637_DAT_GET              PINB4_bit
